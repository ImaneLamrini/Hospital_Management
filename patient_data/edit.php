...
<header>
        ...
        <a href="http://127.0.0.1:8080/projecthospital/patient_data/data.php"><img src="arrow (1).png" alt=""class="back"></a>
...
<div>
    ...
    <div class="firstdiv">
        ...
        <input type="text" name="ipp" id="ipp" value = "<?php echo $row['ipp']; ?>"readonly><br><br>
