...
<head>
    ...
    <link rel="stylesheet" href="agenda_nurse.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="rightone">
            <form action="registeragenda_nurse.php" method="post">
        ...
        <a href="agenda_data_nurse.php"><button class="appoint">See all of Appointments</button></a>
    </div>
</body>
</html>
