...
<head>
    ...
    <link rel="stylesheet" href="register_nurse.css"/>
...
<body>
    <header>
        ...
        <a href="http://127.0.0.1:8080/projecthospital/Nurse/patient_data_nurse/patient_data_nurse.php"><img src="arrow (1).png" alt="back" class="back"></a>
    </header>
    <div>
